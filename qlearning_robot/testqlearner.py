...
# each epoch involves one trip to the goal
    ...
    for epoch in range(1,epochs+1): 
        ...
        while (robopos != goalpos) & (count<100000):
            ...
            #yzhu319: this is experience tuple (robopos, action, newpos, stepreward)=(s,a,s',r)
            ...
            #yzhu319: action in learner.query is random, but in the process Q table is updated
